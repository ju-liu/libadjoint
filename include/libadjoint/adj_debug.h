...
int adj_adjointer_check_checkpoints(adj_adjointer* adjointer); /* Checks that all required variables for the adjoint solve with revolve are stored as checkpoints. Should be called after just before the adjoint main loop */
