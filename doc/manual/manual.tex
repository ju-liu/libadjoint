...
\newcommand{\m}[0]{{\vec{m}}}
%\newcommand{\adjointer}[0]{\hyperref[api:adj_adjointer]{\texttt{adj\_adjointer}}\xspace\index{api:adj_adjointer}}
\newcommand{\adjointer}[0]{\texttt{adj\_adjointer}\xspace\index{api:adj_adjointer}}
