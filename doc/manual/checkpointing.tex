...
This function checks that the validity of all checkpoints, i.e. that the required variables for restarting the simulation at the checkpoint equation are recorded.
