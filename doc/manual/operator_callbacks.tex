...
\begin{boxwithtitle}{Detailed argument list (\texttt{adj_register_forward_source_callback})}
\begin{description}
...
The interface of the supplied function is:

\begin{boxwithtitle}{\texttt{interface}}
\begin{minipage}{\columnwidth}
\begin{ccode}
void functional_callback(adj_adjointer* adjointer, int timestep, 
                         int ndepends, adj_variable* variables, 
                         adj_vector* dependencies, char* name, 
                         adj_scalar* output);
\end{ccode}
...
\begin{minipage}{\columnwidth}
\begin{ccode}
int adj_register_functional_derivative_callback(adj_adjointer* adjointer, char* name, 
...
\begin{minipage}{\columnwidth}
\begin{ccode}
void functional_derivative_callback(adj_adjointer* adjointer,
                               adj_variable variable, int ndepends,
                               adj_variable* variables, adj_vector* dependencies,
                               char* name, adj_vector* output);
\end{ccode}
