...
\item[\texttt{context}] This is an arbitrary pointer to user data, supplied at the time that the block was created during the annotation.
\item[\texttt{output}] This is an \refapi{adj_vector} which will contain the output of the matrix-vector action.
\end{description}
%\end{minipage}
%\end{framed}
