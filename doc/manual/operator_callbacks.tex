...
\refapi{adj_evaluate_functional},
\libadjoint will return an \refapi{ADJ_ERR_NEED_CALLBACK} error.
...
model developer can request the functional value with \refapi{adj_evaluate_functional}. The advantage
