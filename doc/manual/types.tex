...
The \texttt{auxiliary} option defines the type of the variable and must be either \refapi{ADJ_NORMAL_VARIABLE} or \refapi{ADJ_AUXILIARY_VARIABLE}.
...
\texttt{auxiliary} must be either \refapi{ADJ_NORMAL_VARIABLE} \index{ADJ_NORMAL_VARIABLE} or \refapi{ADJ_AUXILIARY_VARIABLE}\index{ADJ_AUXILIARY_VARIABLE}.
