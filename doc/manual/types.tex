...
It stores the required details for the assembly of the adjoint equations, in particular the annotation of the forward model and the associated callbacks routines.
