...
This function queries the number iterations for the variable in \refapi{adjointer} that matches the name, timestep and the auxiliary flag of the model variable \texttt{variable}.
