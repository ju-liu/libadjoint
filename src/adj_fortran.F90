...
module libadjoint_data_structures
  ...
  type, bind(c) :: adj_equation
    ...
    type(c_funptr) :: rhs_second_deriv_action_callback
  ...
  type, bind(c) :: adj_adjointer
    ...
    type(adj_op_callback_list) :: nonlinear_derivative_outer_action_list
...
module libadjoint
  ...
  abstract interface
    ...
    subroutine adj_forward_source_proc(adjointer, variable, ndepends, dependencies, values, context, output, has_output) bind(c)
      use iso_c_binding
      use libadjoint_data_structures
      type(adj_adjointer), intent(in) :: adjointer
      type(adj_variable), intent(in), value :: variable
  ...
  interface
    ...
    function adj_forget_adjoint_values(adjointer, equation) result(ierr) bind(c, name='adj_forget_adjoint_values')
      use libadjoint_data_structures
      use iso_c_binding
      type(adj_adjointer), intent(inout) :: adjointer
      integer(kind=c_int), intent(in), value :: equation
      integer(kind=c_int) :: ierr
    end function adj_forget_adjoint_values

    function adj_forget_tlm_values(adjointer, equation) result(ierr) bind(c, name='adj_forget_tlm_values')
      use libadjoint_data_structures
      use iso_c_binding
      type(adj_adjointer), intent(inout) :: adjointer
      integer(kind=c_int), intent(in), value :: equation
      integer(kind=c_int) :: ierr
    end function adj_forget_tlm_values
