...
adj_nonlinear_block_derivative adj_create_nonlinear_block_derivative(adj_adjointer* adjointer, adj_nonlinear_block nblock, adj_variable var, adj_vector contraction, int hermitian);
void adj_destroy_nonlinear_block_derivative(adj_adjointer*, adj_nonlinear_block_derivative* derivative);
