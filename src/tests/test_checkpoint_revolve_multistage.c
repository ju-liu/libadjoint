...
void get_expected_values(int timestep, int* nb_expected_vars, char expected_vars[][ADJ_NAME_LEN], int* memory_has_value, int* memory_is_checkpoint, int* disk_has_value, int* disk_is_checkpoint)
{
  ...
  case 19:
    *nb_expected_vars=6;
    strncpy(expected_vars[0], "Velocity:5:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[1], "Velocity:10:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[2], "Velocity:14:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[3], "Velocity:16:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[4], "Velocity:18:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[5], "Velocity:19:0:Forward", ADJ_NAME_LEN);
    memory_has_value[0]=0;
    memory_has_value[1]=0;
    memory_has_value[2]=1;
    memory_has_value[3]=1;
    memory_has_value[4]=1;
    memory_has_value[5]=1;
  ...
  case 18:
    *nb_expected_vars=6;
    ...
    strncpy(expected_vars[2], "Velocity:14:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[3], "Velocity:16:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[4], "Velocity:17:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[5], "Velocity:18:0:Forward", ADJ_NAME_LEN);
    memory_has_value[0]=0;
    memory_has_value[1]=0;
    memory_has_value[2]=1;
    memory_has_value[3]=1;
  ...
  case 16:
    *nb_expected_vars=5;
    ...
    strncpy(expected_vars[4], "Velocity:16:0:Forward", ADJ_NAME_LEN);
    memory_has_value[0]=0;
    memory_has_value[1]=0;
    memory_has_value[2]=1;
    memory_has_value[3]=1;
  ...
  case 14:
    *nb_expected_vars=6;
    strncpy(expected_vars[0], "Velocity:5:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[1], "Velocity:10:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[2], "Velocity:11:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[3], "Velocity:12:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[4], "Velocity:13:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[5], "Velocity:14:0:Forward", ADJ_NAME_LEN);
    memory_has_value[0]=0;
    memory_has_value[1]=0;
    memory_has_value[2]=1;
    memory_has_value[3]=1;
  ...
  case 5:
    *nb_expected_vars=6;
    ...
    strncpy(expected_vars[4], "Velocity:4:0:Forward", ADJ_NAME_LEN);
    strncpy(expected_vars[5], "Velocity:5:0:Forward", ADJ_NAME_LEN);
    memory_has_value[0]=0;
    memory_has_value[1]=0;
    memory_has_value[2]=1;
    memory_has_value[3]=1;
